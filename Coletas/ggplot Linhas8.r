...
df1 <- read.csv(file="C:\\Users\\Bernardo\\Desktop\\Projetos\\Python\\GPSCircular\\Coletas\\coleta 1 algoritmo p60 a90.csv",header = TRUE)
df2 <- read.csv(file="C:\\Users\\Bernardo\\Desktop\\Projetos\\Python\\GPSCircular\\Coletas\\coleta 1 algoritmo p60 a150.csv",header = TRUE)
df3 <- read.csv(file="C:\\Users\\Bernardo\\Desktop\\Projetos\\Python\\GPSCircular\\Coletas\\coleta 1 algoritmo p60 a180.csv",header = TRUE)
df4 <- read.csv(file="C:\\Users\\Bernardo\\Desktop\\Projetos\\Python\\GPSCircular\\Coletas\\coleta 1 algoritmo p80 a90.csv",header = TRUE)
df5 <- read.csv(file="C:\\Users\\Bernardo\\Desktop\\Projetos\\Python\\GPSCircular\\Coletas\\coleta 1 algoritmo p80 a150.csv",header = TRUE)
df6 <- read.csv(file="C:\\Users\\Bernardo\\Desktop\\Projetos\\Python\\GPSCircular\\Coletas\\coleta 1 algoritmo p80 a180.csv",header = TRUE)
